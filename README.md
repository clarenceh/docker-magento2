skywidesoft/docker-magento2
=================

Out-of-the-box LAMP image (PHP 5.6 + MySQL 5.6)


Usage
-----

To create the image `skywidesoft/docker-magento2`, execute the following command on the tutum-docker-lamp folder:

	docker build -t skywidesoft/docker-magento2 .

You can now push your new image to the registry:

	docker push skywidesoft/docker-magento2
...
Start your image binding the external ports 80 and 3306 in all interfaces to your container:
	...
	docker run -d -p 80:80 -p 3306:3306 skywidesoft/docker-magento2
